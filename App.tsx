...
import EditClient from './pages/EditClient'; // Import the new component
  ...
  return (
    <HashRouter>
      <Routes>
        ...
        <Route path="/clients/:id/edit" element={session ? <Layout userRole={role}><EditClient /></Layout> : <Navigate to="/login" />} /> {/* New Edit Client Route */}
